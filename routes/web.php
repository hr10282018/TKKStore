...
/*发布商品*/
Route::get('/create_goods', 'GoodsController@create_goods')->name('create_goods'); // 登录页面
Route::post('/create_goods', 'GoodsController@create_goods_check')->name('create_goods'); // 登录页面


/* 商品详情 */
Route::get('/goods', 'SessionsController@goods')->name('goods'); // 登录页面
